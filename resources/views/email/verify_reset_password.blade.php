...
<head>
	...
	<title>@lang('email.email_reset_password_verify_subject')</title>
</head>
				...
				<table align="center" border="0" width="500px" cellpadding="0" cellspacing="0" dir="{{$dir}}" style="text-align:center;border-width:0px;max-width:500px;width:100%;min-width:288px;">
					...
					<tr>
						<td align="{{$direction}}" style="text-align:{{$direction}};padding:8px 0px;">
							<span style="font-size:20px;color:#12733a;"><b>@lang('email.email_reset_password_verify_title')</b></span>
						</td>
					</tr>
					<tr>
						<td align="{{$direction}}" style="text-align:{{$direction}};padding:8px 0px;">
							<span>@lang('email.email_reset_password_verify_subtitle')</span>
						</td>
					</tr>
					<tr>
