    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="rated" action="{{route('categories.store')}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="2" class="form-control" name="description_ar">{{old('description_ar')}}</textarea>
                            </div>
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="2" class="form-control" name="description_en">{{old('description_en')}}</textarea>
                            </div>
                        ...
                        <div class="col-6 ">
                            <div class="form-group">
                                ...
                                <select name="type" id="" class="form-control">
                                    <option value="1" {{old('type') == 1 ? 'selected' : ''}}>Personal</option>
