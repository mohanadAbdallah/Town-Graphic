                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title_ar" disabled name="title_ar" value="{{$category->title_ar}}">
                            </div>


                            <div class="form-group">
                                <label class="control-label" for="name">Description (AR)</label>
                                <textarea rows="2" class="form-control" disabled name="description_ar">{{$category->description_ar}}</textarea>
                            </div>
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" disabled id="title_en" name="title_en" value="{{$category->title_en}}">
                            </div>


                            <div class="form-group">
                                <label class="control-label" for="name">Description (EN)</label>
                                <textarea rows="2" class="form-control" disabled name="description_en">{{$category->description_en}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ">
                            <div class="form-group">
                                ...
                                <select name="type" id="" disabled class="form-control">
