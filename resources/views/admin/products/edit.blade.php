                    ...
                    <div class="row">
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="3" class="form-control" name="description_ar">{{$product->description_ar}}</textarea>
                            </div>

                            <div class="form-group">
                                <label class="control-label" for="name">Description (EN)</label>
                                <textarea rows="3" class="form-control" name="description_en">{{$product->description_en}}</textarea>
                            </div>

                            <div class="form-group">
                                <label class="control-label" for="name">Material type (AR)</label>
                                <input type="text" class="form-control" id="material_type_ar" name="material_type_ar" value="{{$product->material_type_ar}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="name">Material type (EN)</label>
                                <input type="text" class="form-control" id="material_type_en" name="material_type_en" value="{{$product->material_type_en}}">
                            </div>
                        ...
                        <div class="col-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="images_count_ar" name="images_count_ar" value="{{$product->images_count_ar}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="name">Count images (EN)</label>
                                <input type="text" class="form-control" id="images_count_en" name="images_count_en" value="{{$product->images_count_en}}">
                            </div>
                            <div class="form-group">
